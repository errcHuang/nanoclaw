...
**Credential handling:** Authentication variables (`CLAUDE_CODE_OAUTH_TOKEN`, `ANTHROPIC_API_KEY`) are passed to the container via stdin rather than environment variables or mounted files. Other env vars are not exposed.
